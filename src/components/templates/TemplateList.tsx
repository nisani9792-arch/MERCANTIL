...
export function TemplateList() {
  ...
  const edit = (item: RecurringTemplate) => openDraft({ id: item.id, name: item.name, amount: String(item.amount), type: item.type, frequency: item.frequency, dayOfMonth: item.day_of_month ? String(item.day_of_month) : "", isActive: item.is_active });
